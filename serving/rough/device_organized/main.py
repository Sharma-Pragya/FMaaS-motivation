...
from device.fmapi import RuntimeServerConfig, serve
...
def main():
    ...
    parser.add_argument("--max-batch-size", type=int, default=20, help="Maximum cross-task batch size.")
    parser.add_argument("--max-batch-wait-ms", type=float, default=1000, help="Maximum batch formation wait.")
