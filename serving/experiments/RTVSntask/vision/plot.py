#!/usr/bin/env python3
"""RTVSntask/vision/plot.py — Plots for the sharing-benefit + TPC experiment (vision).
...
Usage:
    python experiments/RTVSntask/vision/plot.py \\
        [--exp-dir experiments/RTVSntask/vision/results_vision_t4] \\
        [--rps-sweep 25] \\
...
def main() -> int:
    ...
    parser.add_argument("--exp-dir",         default=os.environ.get("EXP_DIR",
                        "experiments/RTVSntask/vision/results_dinobase"))
