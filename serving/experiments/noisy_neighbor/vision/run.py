...
def main() -> int:
    ...
    parser.add_argument("--backbone",             default="dinolarge-patch")
    ...
    parser.add_argument("--exp-dir",              default=os.environ.get(
                        "EXP_DIR", "experiments/noisy_neighbor/vision/results/fcfs"))
    ...
    print("=" * 65)
    print(f"  noisy_neighbor/vision — {num_phases}-phase experiment")
