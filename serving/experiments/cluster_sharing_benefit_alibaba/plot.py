...
def _bars_vs_n(data, value_fn, ylabel: str, out_path: Path,
    ...
    def _break_marks(ax_obj: plt.Axes, bottom: bool) -> None:
        """Draw the classic diagonal // marks at the broken edge."""
        d = 0.018
    ...
    if use_break:
        # Compact figure: bottom panel ≈2× the height of the top panel.
...
def main() -> None:
    ...
    parser.add_argument("--exp-dir", type=str,
                        default=str(SERVING_DIR / "experiments/cluster_sharing_benefit_alibaba/results_alibaba"))
