...
POLICIES: Dict[str, Dict] = {
    ...
    "no_sharing_tpc":  {"color": "#6B9AC4", "label": "No-Sharing (TPC)", "ls": (0, (5, 2))},
}

# Draw order: FCFS first (bottom) → STFQ → BFQ → No-Sharing TPC last (top)
POLICY_ORDER = ["fcfs", "stfq", "bfq", "no_sharing_tpc"]
...
def main() -> int:
    default_base = "experiments/noisy_neighbor_infra/tsfm/results"
