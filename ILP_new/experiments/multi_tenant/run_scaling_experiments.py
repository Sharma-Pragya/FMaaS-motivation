"""
Scaling experiments for multi-tenant ILP: varying number of tasks.
...
def main():
    parser = argparse.ArgumentParser(description="Scaling experiments for multi-tenant ILP")
    parser.add_argument(
        "--workload",
        type=str,
        nargs="+",
    ...
    print(f"Multi-Tenant Scaling Experiment Plan:")
