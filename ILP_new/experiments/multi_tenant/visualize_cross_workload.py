...
def plot_cross_workload_metric(metric_name, summaries, output_dir, output_format="png"):
    ...
    metric_configs = {
        "memory": {
            ...
            "title": "Cross-Workload: Memory Footprint vs. Number of Tasks",
        },
        "throughput": {
            "key": "throughput_req_s",
            "ylabel": "Total System Throughput (req/s)",
            "title": "Cross-Workload: Throughput vs. Number of Tasks",
        },
        "latency": {
            "key": "avg_latency_ms",
            "ylabel": "Average Latency (ms)",
            "title": "Cross-Workload: Average Latency vs. Number of Tasks",
        },
    }
    ...
    for workload_type, summary in summaries.items():
        ...
        task_counts = sorted(summary["task_counts"])
    ...
    # Formatting
    ax.set_xlabel("Number of Tasks", fontsize=13, fontweight='bold')
...
def main():
    results_dir = os.path.join(os.path.dirname(__file__), "results", "scaling")
