"""
Request rate scaling experiments for multi-tenant ILP.
...
def main():
    parser = argparse.ArgumentParser(description="Request rate scaling experiments for multi-tenant ILP")
    parser.add_argument(
        "--workload",
        type=str,
        nargs="+",
    ...
    print(f"Multi-Tenant Request Rate Scaling Experiment Plan:")
