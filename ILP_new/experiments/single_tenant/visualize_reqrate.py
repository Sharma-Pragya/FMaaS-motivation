...
COLORS = {
    "deployments": "#1f77b4",
    "deployments_devices": "#ff7f0e",
    "deployments_devices_waste": "#2ca02c",
    "deployments_devices_waste_modelsize": "#d62728",
}

LABELS = {
    "deployments": "O1: Deployments",
    "deployments_devices": "O1+O2: Dep+Dev",
    "deployments_devices_waste": "O1+O2+O3: +Waste",
    "deployments_devices_waste_modelsize": "O1+O2+O3+O4: +ModelSize",
}
